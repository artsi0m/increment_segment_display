...
avra version I will try to change it to 1Mhz. 8bit Timer/Counter1 was
used.

I plan to port this code from atmel studio to
traditional +emacs+ unix-like (+OpenBSD+ Gentoo) environment + plus switch to lower frequency
of MCU.
...
(Command from windows/Atmel IDE project)
